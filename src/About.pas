...
//  LinkVersionDatei = 'https://vp52ltwsh65grajn.myfritz.net:45443/nas/filelink.lua?id=5d5ddba3c0b7b098';
  LinkVersionDatei = 'https://vp52ltwsh65grajn.myfritz.net/nas/filelink.lua?id=5d5ddba3c0b7b098';
...
//  LinkSetupDatei   = 'https://vp52ltwsh65grajn.myfritz.net:45443/nas/filelink.lua?id=78c40357f43e0e91';
  LinkSetupDatei   = 'https://vp52ltwsh65grajn.myfritz.net/nas/filelink.lua?id=78c40357f43e0e91';
...
begin
  lblWinVersion.Caption := 'Windows Ver.: ' + WMI_Get_Betriebssystem(True);
...
//  inherited;
  ...
  begin
    try
      ...
      if (RCode >= 200) and (RCode < 300) {and not IsHTML(RemoteVersion)} then
        CheckVersion;
    except
