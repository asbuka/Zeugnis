...
//    dtSyntaxCheck:    Result := '0';    {* Syntax Prüfen *}
//    dtDeckblattA3:    Result := '13';   {* Deckblatt A3 (Bericht, Norm) *}                             Alt 6
//    dtDeckblattA4:    Result := '14';   {* Deckblatt A4 (Gespraechsgrundlage) *}                       Alt 9
//    dtRTF_Text:       Result := '20';   {* RTF Text (A3, A4) *}                                        Alt 7
//    dtRTF_Bemerkung:  Result := '30';   {* RTF Fach Bemerkung *}                                       Alt 8
//    dtFachZusatzText: Result := '40';   {* Überfachliche Kompetenzen, Fachtext, Torte *}               Alt 1
//    dtPunktGrp:       Result := '51';   {* Punkt Bezeichnung *}                                        Alt 3
//    dtPunktWert:      Result := '52';   {* Torten Value *}                                             Alt 2
//    dtBemerkung:      Result := '60';   {* Bemerkung (A3, A4) *}                                       Alt 4
//    dtAbschluss:      Result := '90';   {* Versäumnisse, Ammersbek, Schulleiterin, Sorgeberechnige *}  Alt 5

  TDruckTyp = (dtSyntaxCheck, dtDeckblattA3 = 13, dtDeckblattA4 = 14, dtRTF_Text = 20, dtRTF_Bemerkung = 30, dtFachZusatzText = 40, dtPunktGrp = 51, dtPunktWert = 52, dtBemerkung = 60, dtAbschluss = 90);
...
{$IFDEF _LL26_}
    ...
    procedure BDefineCurrentRecord_LL26(ForDesign: Boolean;
      PersonalDaten: IXMLNode; ADruckTyp: TDruckTyp; AFarbe, AFachName, AText, ARTFText, AWert, AFontStyle, ATorten,
...
{$IFDEF _LL26_}
  ...
  begin
    {D:  Daten definieren}
    {D:  Daten definieren}
    DefineCurrentRecord_LL26(True, nil, dtSyntaxCheck, '0', '', '', '', '0', '', 'F', 'F', 'F', 'F', 'F', '', '0');
...
begin
  ...
  DefineCurrentRecord_LL26(False, PersonalDaten, dtSyntaxCheck, '0', ' ', ' ', ' ', '0', '', 'F', 'F', 'F', Bericht, GesprGrdl, '', '0');
...
//    end;
  ...
  begin
    DefineCurrentRecord_LL26(False, PersonalDaten, dtDeckblattA3, '0', ' ', ' ', ' ', '0', '', 'F', 'F', 'F', Bericht, GesprGrdl, '', '0');
    LLPrintFields_LL26;
    LL26.LlPrint;
  end else
  begin
    DefineCurrentRecord_LL26(False, PersonalDaten, dtDeckblattA4, '0', ' ', ' ', ' ', '0', '', 'F', 'F', 'F', Bericht, GesprGrdl, '', '0');
    LLPrintFields_LL26;
  end;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            if (PrintAktion = paPrint) and (GetPapierFormat = DMPAPER_A3) then
            begin
              DefineCurrentRecord_LL26(False, PersonalDaten, dtRTF_Text, '0', FachBez, RTF2PlainText(VarToStrDef(RTFTextNode.NodeValue, '')),
          ...
          begin
            ...
            if (PrintAktion = paPrint) and (GetPapierFormat = DMPAPER_A3) then
              DefineCurrentRecord_LL26(False, PersonalDaten, dtRTF_Bemerkung, '0', FachBez, RTF2PlainText(VarToStrDef(BemerkungNode.ChildValues['Text'], '')),
        ...
        begin
          ...
          DefineCurrentRecord_LL26(False, PersonalDaten, dtFachZusatzText, '0', FachBez, FachBez,
             ' ',
             '0', '', VarToStr(FachNode.Attributes['Torten']), 'F', FKompetenz, Bericht, GesprGrdl, FachZusatzText, '0');
          LLPrintFields_LL26;
            ...
            begin
              ...
              begin
                if StrToInt(VarToStrDef(FachNode.ChildNodes[Idy].ChildValues['Wert'], '0')) < 0 then
                  DefineCurrentRecord_LL26(False, PersonalDaten, dtPunktGrp, VarToStrDef(FachNode.ChildNodes[Idy].ChildValues['Farbe'], '0'), FachBez,
                  ...
                  DefineCurrentRecord_LL26(False, PersonalDaten, dtPunktWert, VarToStrDef(FachNode.ChildNodes[Idy].ChildValues['Farbe'], '0'), FachBez,
                    CheckLexicon(VarToStrDef(FachNode.ChildNodes[Idy].ChildValues['Text'], ' ')), ' ',
                    VarToStrDef(FachNode.ChildNodes[Idy].ChildValues['Wert'], '0'),
                    VarToStrDef(FachNode.ChildNodes[Idy].ChildNodes.FindNode('Font').Attributes['FontStyle'], ''),
                    'F', 'F', 'F', Bericht, GesprGrdl, '', '0');
              ...
              begin
                ...
                if (PrintAktion = paPrint) and (GetPapierFormat = DMPAPER_A3) then
                  DefineCurrentRecord_LL26(False, PersonalDaten, dtBemerkung, '0', FachBez,
  ...
  DefineCurrentRecord_LL26(False, PersonalDaten, dtAbschluss, '0', ' ', ' ', ' ', '0', '', 'F', 'F', 'F', Bericht, GesprGrdl, '', '0');
  LLPrintFields_LL26;
...
procedure TfrmErfassung.DefineCurrentRecord_LL26(ForDesign: Boolean;
  PersonalDaten: IXMLNode; ADruckTyp: TDruckTyp; AFarbe, AFachName, AText, ARTFText, AWert,
...
begin
  ...
  begin
    ...
    LL26.LlDefineFieldExt('Typ', IntToStr(Ord(dtSyntaxCheck)), LL_NUMERIC);
  ...
  begin
    ...
    LL26.LlDefineFieldExt('Typ', IntToStr(Ord(ADruckTyp)), LL_NUMERIC);
...
begin
  ...
  cmbSchuljahr.Items.Add('2025/2026');
  cmbSchuljahr.Items.Add('2026/2027');
  cmbSchuljahr.Items.Add('2027/2028');
  cmbSchuljahr.Items.Add('2028/2029');
...
begin
  ...
  begin
    ...
    FLL26.LlDefineFieldExt('Typ', IntToStr(Ord(dtSyntaxCheck)), LL_NUMERIC);
  ...
  begin
    ...
    FLL26.LlDefineFieldExt('Typ', IntToStr(Ord(ADruckTyp)), LL_NUMERIC);
...
begin
  ...
  {D:  Daten definieren. Die hier übergebenen Daten dienen nur der Syntaxprüfung - die Inhalte
       brauchen keine Echtdaten zu enthalten}
  BDefineCurrentRecord_LL26(False, PersonalDaten, dtSyntaxCheck, '0', ' ', ' ', ' ', '0', '', 'F', 'F', 'F', Bericht, GesprGrdl, '', '0');
...
//    end;
  ...
  if not s2b(GesprGrdl) then
  begin
    BDefineCurrentRecord_LL26(False, PersonalDaten, dtDeckblattA3, '0', ' ', ' ', ' ', '0', '', 'F', 'F', 'F', Bericht, GesprGrdl, '', '0');
    FLLPrintFields_LL26;
    FLL26.LlPrint;
  end else
  begin
    BDefineCurrentRecord_LL26(False, PersonalDaten, dtDeckblattA4, '0', ' ', ' ', ' ', '0', '', 'F', 'F', 'F', Bericht, GesprGrdl, '', '0');
    FLLPrintFields_LL26;
  end;

  {D:  Eigentliche Druckschleife; Wiederholung, solange Daten vorhanden}
  if s2b(GesprGrdl) then
    ZeugnisNode := BRoot.ChildNodes.FindNode('ZeugnisInhaltGGL');
  if not Assigned(ZeugnisNode) then
    ZeugnisNode := BRoot.ChildNodes.FindNode('ZeugnisInhalt');
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            begin
              BDefineCurrentRecord_LL26(False, PersonalDaten, dtRTF_Text, '0', FachBez, RTF2PlainText(VarToStrDef(RTFTextNode.NodeValue, '')),
                 CheckLexicon(SetRTFFontSize(RTFOhneFarbe(VarToStrDef(RTFTextNode.NodeValue, '')), StrToIntDef(Schriftgrad, MemoSGDef))),
                 '0', '', 'F', 'F', FKompetenz, Bericht, GesprGrdl, FachZusatzText, Schriftgrad)
            end else
              BDefineCurrentRecord_LL26(False, PersonalDaten, dtRTF_Text, '0', FachBez, RTF2PlainText(VarToStrDef(RTFTextNode.NodeValue, '')),
          ...
          begin
            Schriftgrad := VarToStrDef(BemerkungNode.ChildValues['Schriftgrad'], IntToStr(MemoSGDef));
            if (BPrintAktion = paPrint) and (GetPapierFormat = DMPAPER_A3) then
              BDefineCurrentRecord_LL26(False, PersonalDaten, dtRTF_Bemerkung, '0', FachBez, RTF2PlainText(VarToStrDef(BemerkungNode.ChildValues['Text'], '')),
                 SetRTFFontSize(TrimRTF(VarToStrDef(BemerkungNode.ChildValues['Text'], '')), StrToIntDef(Schriftgrad, MemoSGDef)),
                 '0', '', 'F', 'F', FKompetenz, Bericht, GesprGrdl, FachZusatzText, Schriftgrad)
            else
              BDefineCurrentRecord_LL26(False, PersonalDaten, dtRTF_Bemerkung, '0', FachBez, RTF2PlainText(VarToStrDef(BemerkungNode.ChildValues['Text'], '')),
        ...
        begin
          ...
          BDefineCurrentRecord_LL26(False, PersonalDaten, dtFachZusatzText, '0', FachBez, FachBez,
             ' ',
             '0', '', VarToStr(FachNode.Attributes['Torten']), 'F', FKompetenz, Bericht, GesprGrdl, FachZusatzText, '0');
          FLLPrintFields_LL26;
          ...
          begin
            ...
            begin
              ...
              begin
                if StrToInt(VarToStrDef(FachNode.ChildNodes[Idy].ChildValues['Wert'], '0')) < 0 then
                  BDefineCurrentRecord_LL26(False, PersonalDaten, dtPunktGrp, VarToStrDef(FachNode.ChildNodes[Idy].ChildValues['Farbe'], '0'), FachBez,
                    CheckLexicon(VarToStrDef(FachNode.ChildNodes[Idy].ChildValues['Text'], ' ')), ' ',
                    VarToStrDef(FachNode.ChildNodes[Idy].ChildValues['Wert'], '0'),
                    VarToStrDef(FachNode.ChildNodes[Idy].ChildNodes.FindNode('Font').Attributes['FontStyle'], ''),
                    'F', 'F', 'F', Bericht, GesprGrdl, '', '0')
                else
                  BDefineCurrentRecord_LL26(False, PersonalDaten, dtPunktWert, VarToStrDef(FachNode.ChildNodes[Idy].ChildValues['Farbe'], '0'), FachBez,
                    CheckLexicon(VarToStrDef(FachNode.ChildNodes[Idy].ChildValues['Text'], ' ')), ' ',
                    VarToStrDef(FachNode.ChildNodes[Idy].ChildValues['Wert'], '0'),
                    VarToStrDef(FachNode.ChildNodes[Idy].ChildNodes.FindNode('Font').Attributes['FontStyle'], ''),
                    'F', 'F', 'F', Bericht, GesprGrdl, '', '0');
              ...
              begin
                Schriftgrad := VarToStrDef(FachNode.ChildNodes[Idy].ChildValues['Schriftgrad'], IntToStr(MemoSGDef));
                if (BPrintAktion = paPrint) and (GetPapierFormat = DMPAPER_A3) then
                  BDefineCurrentRecord_LL26(False, PersonalDaten, dtBemerkung, '0', FachBez,
      //              StringReplace(VarToStrDef(FachNode.ChildNodes[Idy].ChildValues['Text'], ' '), '<br>', #13#10, [rfReplaceAll]), '0', '', 'F',
                    RTF2PlainText(VarToStrDef(FachNode.ChildNodes[Idy].ChildValues['Text'], ' ')),
                    SetRTFFontSize(TrimRTF(VarToStrDef(FachNode.ChildNodes[Idy].ChildValues['Text'], ' ')), StrToIntDef(Schriftgrad, MemoSGDef)),
                    '0', '', 'F', b2s(NurBemerkung), 'F', Bericht, GesprGrdl, '', Schriftgrad)
      ...
      {D:  Fortschrittsanzeige aktualisieren}
      FLL26.LlPrintSetBoxText('Drucken ...', Round(Idx/ZeugnisNode.ChildNodes.Count * 100));
    end;
  end;

  // Schulleiter(in) und Erziehungs Text Drucken
  BDefineCurrentRecord_LL26(False, PersonalDaten, dtAbschluss, '0', ' ', ' ', ' ', '0', '', 'F', 'F', 'F', Bericht, GesprGrdl, '', '0');
  FLLPrintFields_LL26;
